...
export const ROUTE_TO_PAGE_ID: Record<string, string> = {
  ...
  '/physical-inventory/orders': 'physical-inventory-orders',
  '/physical-inventory/orders/create': 'physical-inventory-orders-create',
  '/physical-inventory/orders/:id': 'physical-inventory-orders-detail',
  '/physical-inventory/orders/:id/review': 'physical-inventory-orders-review',
  '/scrap': 'scrap',
